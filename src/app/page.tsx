...
const projects: Project[] = [
  ...
  {
    title: "IDX Trading Lab",
    description: "Market-analysis web lab for exploring Indonesian stock data and trading workflows.",
    link: "https://idx-trading-lab.vercel.app/",
    image: "https://images.unsplash.com/photo-1642790106117-e829e14a795f?q=80&w=2070&auto=format&fit=crop",
    tags: ["Next.js", "Data UI", "Trading", "Vercel"],
    icon: ChartNoAxesCombined,
    year: "2026",
    role: "Data-focused web product",
    spotlight: "A trading research interface shaped around market exploration, scanable analysis, and public deployment.",
    metrics: ["IDX market focus", "Analysis workflow", "Vercel deployment"],
    narrative: [
      "Built the project as a focused lab for turning market information into a more structured analysis flow.",
      "Prioritized readable data presentation so trading context can be scanned quickly during review.",
      "Deployed the app publicly on Vercel to make the workflow easy to access and share.",
    ],
    mood: {
      tone: "executive",
      aura: ["rgba(34, 197, 94, 0.28)", "rgba(14, 165, 233, 0.24)"],
      sheen: "rgba(187, 247, 208, 0.45)",
      overlay: ["rgba(0, 0, 0, 0.04)", "rgba(5, 30, 24, 0.82)"],
      accent: "#22c55e",
      icon: "#86efac",
      chipBg: "rgba(34, 197, 94, 0.14)",
      chipBorder: "rgba(34, 197, 94, 0.34)",
      auraSpeed: 8.4,
      hover: { y: -8, rotateX: 2.8, rotateY: -2.2, scale: 1.014 },
    },
    cue: {
      name: "Market Signal",
      motif: [196, 246, 329, 392],
      waveform: "square",
      pan: [-0.12, 0.24],
      glide: 1.05,
      q: 1.18,
